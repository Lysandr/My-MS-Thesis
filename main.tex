...
\abstract{  \OnePageChapter				% because it is very short
	...
	Autonomous propulsive spacecraft have enabled the exploration of other planets, moons, asteroids, and other celestial bodies. Recent advances in real-time optimal guidance algorithms are enabling spacecraft to perform 

	This thesis focuses on the implementation and development of a 6 degree-of-freedom (DoF) guidance algorithm that solves the powered descent guidance (PDG) problem. I present a modified version of the Szmuk-Acikmese 6-DoF algorithm presented in \cite{szmuk2018successive} which employs modified Rodrigues parameters (MRPs). 
...
As an unordered set, I am grateful for the insightful technical discussions I have had with Shez Virani, Daniel Aguilar-Marsillach, the EsDL research team, Sven Niederberger, Benjamin Chung, Janis Maczijewski, Joe Barnard, Miki Szmuk, Skye Mceowen, Ian Garcia,  and many more.
